...
def lnlikelihood(theta, ha, e_ha, d4000, e_d4000, hb, e_hb, hdA, e_hdA, mgfe, e_mgfe, age):
    """ 
...
def lnprobability(theta, ha, e_ha, d4000, e_d4000, hb, e_hb, hdA, e_hdA, mgfe, e_mgfe, age):
    """
...
def sample(path, ndim=3, nwalkers=100, nsteps=100, burnin=500, start=[1.0, 13.0, np.log10(1.0)], ha=np.nan, e_ha=np.nan, d4000=np.nan, e_d4000=np.nan, hb=np.nan, e_hb=np.nan, hdA=np.nan, e_hdA=np.nan, mgfe=np.nan, e_mgfe=np.nan, age=Planck15.age(0).value, ID=0):
    ...
    sampler = emcee.EnsembleSampler(nwalkers, ndim, lnprobability, args=(ha, e_ha, d4000, e_d4000, hb, e_hb, hdA, e_hdA, mgfe, e_mgfe, age))
    """ Burn in run here..."""
